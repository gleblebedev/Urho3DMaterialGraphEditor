...
```
{
  "Type": "lessThanEqual(vec2,vec2)",
  "Name": "lessThanEqual(vec2,vec2)",
  "Category": 1,
  "InputPins": [
    {
      "Connection": null,
...
```
{
  "Type": "lessThanEqual(vec3,vec3)",
  "Name": "lessThanEqual(vec3,vec3)",
  "Category": 1,
  "InputPins": [
    {
      "Connection": null,
...
```
{
  "Type": "lessThanEqual(vec4,vec4)",
  "Name": "lessThanEqual(vec4,vec4)",
  "Category": 1,
  "InputPins": [
    {
      "Connection": null,
...
```
{
  "Type": "lessThanEqual(ivec2,ivec2)",
  "Name": "lessThanEqual(ivec2,ivec2)",
  "Category": 1,
  "InputPins": [
    {
      "Connection": null,
...
```
{
  "Type": "lessThanEqual(ivec3,ivec3)",
  "Name": "lessThanEqual(ivec3,ivec3)",
  "Category": 1,
  "InputPins": [
    {
      "Connection": null,
...
```
{
  "Type": "lessThanEqual(ivec4,ivec4)",
  "Name": "lessThanEqual(ivec4,ivec4)",
  "Category": 1,
  "InputPins": [
    {
      "Connection": null,
